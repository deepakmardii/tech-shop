...
function Cart() {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-20">
      <h1 className="text-3xl text-center font-semibold mb-6">Cart</h1>
      ...
      <div className="mt-6 max-w-sm mx-auto space-y-4">
        <button className="text-lg w-full font-semibold text-center mr-4 py-2 px-4 rounded  hover:bg-white border">
          Checkout
        </button>

        <button className="text-lg w-full font-semibold text-center mr-4 bg-white hover:text-white border py-2 px-4 rounded">
          Back to Shopping
        </button>
      </div>
    </div>
