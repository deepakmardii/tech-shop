    ...
    <div className="max-w-7xl mx-auto mt-20">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="shadow-md relative h-96 overflow-hidden aspect-ratio-1">
          <img src="painting.jpg" layout="fill" objectFit="cover" alt="art" />
        </div>

        {/* Right - Details */}
        <div className="flex flex-col p-6 justify-between">
          <h1 className="text-3xl font-semibold">Iphone 15</h1>
          <p className="text-lg text-gray-500 mt-4">
            Iphone 15 pro max 2023 version best phone
          </p>
          ...
          <div className="mt-6">
            <button className="text-white px-6 py-3 rounded-md">
              Add to Cart
            </button>
          </div>
        </div>
